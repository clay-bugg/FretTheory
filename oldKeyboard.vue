<template>
  <div id="component">
    ...
    <div id="controls">
      ...
      <div id="chord-select-container">
        ...
        <select id="chord-select"
          ...
          <option v-for="chord in chordOptions"
                  :key="chord"
                  :value="chord">{{ chord }}</option>
        </select>
        
        <select id="chord-type-select"
                v-model="selectedChordType">
          <option v-for="type in chordTypeOptions"
                  :key="type.value"
                  :value="type.value">
            {{ type.label }}
          </option>
    ...
    <div id="chord-played"
         v-if="selectedChord && selectedChordType">
      <p id="
         chord"> {{ notesPlayed }}</p>
      <button @click="playChord(notesPlayed)">Play Note</button>
    </div>
